...
def compute_msssim(img1, img2, max_val=255, filter_size=11, filter_sigma=1.5,
                   k1=0.01, k2=0.03, weights=None):
  img1 = img1.detach().cpu().numpy().transpose(0,2,3,1)
  img2 = img2.detach().cpu().numpy().transpose(0,2,3,1)
  img1 = (img1-img1.min()) / (img1.max()-img1.min())
  img2 = (img2-img2.min()) / (img2.max()-img2.min())
  return MultiScaleSSIM(img1, img2, max_val=1.0)
...
def main():
  ...
  # img2 = img1
  print((compute_msssim(img1, img2, max_val=255)))
